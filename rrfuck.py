...
def helpnote():
	...
	exit(" [*] FACEBOOK :  https://www.facebook.com/AbRaHaM.Er.AbBu.01")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰🥰 MR-RAFU")
	subprocess.check_output(["am", "start", "https://m.me/AbRaHaM.Er.AbBu.01"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Rafu0878/anotherapproval.txt.git').text
			if basesplit in plr:
				key = basesplit
